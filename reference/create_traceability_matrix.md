...
Returns a table that links all exported functions and their aliases to
their documentation (\`man\` files), the R scripts containing them, and
...
- verbose:
  ...
  Logical (\`TRUE\`/\`FALSE\`). If \`TRUE\`, show any warnings/messages
  per function.
