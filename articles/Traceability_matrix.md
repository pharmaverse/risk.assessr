...
Firstly, if you just want a traceability matrix with no test coverage,
...
Secondly, if you want a traceability matrix with test coverage, you can
...
If you want a full analysis of the package containing a traceability
...
This returns a structured list with traceability and function risk
information.
...
See how functions are mapped to risk and test coverage. This shows all
...
This shows functions categorized as high, medium, or low risk test
coverage.
